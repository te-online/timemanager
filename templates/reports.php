						...
						<div class="tm_item-row" data-remove-on-delete="<?php p($time->getUuid()); ?>">
							...
							<div class="tm_item-excerpt">
								...
								<div class="tm_item-date">
									<?php p($entry->project->getName()); ?>&nbsp;&middot;&nbsp;<?php p($entry->task->getName()); ?>&nbsp;&middot;&nbsp;<span data-datetime="<?php p($time->getStartFormatted("Y-m-d H:i:s")); ?>"><?php p($time->getStartLocalized()); ?></span>
